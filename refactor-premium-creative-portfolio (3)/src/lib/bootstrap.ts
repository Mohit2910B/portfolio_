...
const PROJECT_SEED: SeedProject[] = [
  {
    title: "Concrete Light — Property Film",
    description:
  ...
  },
  {
    ...
    description: "Animated identity elements — logo resolve, type behaviour and transition language.",
...
async function seedContent() {
  ...
  if ((await count("layout_sections")) === 0) {
    ...
    await db
      ...
      .values({ sectionKey: "tools", label: "Tools & Software", sortOrder: 2, isVisible: true })
      .onConflictDoNothing();
  }
